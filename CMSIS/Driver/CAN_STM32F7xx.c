...
Peripheral Resource | STM32756G-EVAL       |
:-------------------|:---------------------|
CAN1 Mode           | CAN1: <b>Master</b>  |
CAN1_RX pin         | PA11                 |
CAN1_TX pin         | PA12                 |
CAN2 Mode           | CAN2: <b>Slave</b>   |
CAN2_RX pin         | n/a                  |
CAN2_TX pin         | n/a                  |
 
For different boards, refer to the hardware schematics to reflect correct setup values.
 
The STM32CubeMX configuration for STMicroelectronics STM32756G-EVAL Board with steps for Pinout, Clock, and System Configuration are 
