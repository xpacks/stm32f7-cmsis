 ...
 * Project:      CAN Driver for ST STM32F7xx
 * --------------------------------------------------------------------------
...
/*! \page stm32f7_can CMSIS-Driver CAN Setup

The CMSIS-Driver CAN requires:
  - APB1 Clock (maximum frequency is 50 MHz)
  - Configuration of CAN
 
Valid settings for various evaluation boards are listed in the table below:

Peripheral Resource | STM32756G-EVAL       | STM32F779I-EVAL      |
:-------------------|:---------------------|:---------------------|
CAN1 Mode           | CAN1: <b>Master</b>  | CAN1: <b>Master</b>  |
CAN1_RX pin         | PA11                 | PA11                 |
CAN1_TX pin         | PA12                 | PA12                 |
CAN2 Mode           | CAN2: <b>Slave</b>   | CAN2: <b>Slave</b>   |
CAN2_RX pin         | n/a                  | n/a                  |
CAN2_TX pin         | n/a                  | n/a                  |
CAN3 Mode           | CAN3: <b>Master</b>  | CAN3: <b>Master</b>  |
CAN3_RX pin         | n/a                  | n/a                  |
CAN3_TX pin         | n/a                  | n/a                  |
 
For different boards, refer to the hardware schematics to reflect correct setup values.
 
The STM32CubeMX configuration for STMicroelectronics STM32756G-EVAL or STM32F779I-EVAL Board with steps for 
Pinout, Clock, and System Configuration are listed below. Enter the values that are marked \b bold.
...
-----------------------
  1. Configure APB1 Clock (maximum frequency is 50 MHz)
...
-----------------
  1. Under Connectivity open \b CAN1 Configuration:
     ...
     - <b>GPIO Settings</b>: review settings, no changes required
          ...
          :--------|:--------------|:------------|:-------------------|:------------|:----------
          PA11     | CAN1_RX       | Alternate ..| No pull-up and no..| High        |.
          PA12     | CAN1_TX       | Alternate ..| No pull-up and no..| High        |.
