...
#if    (RTE_USB_OTG_HS == 1)
#if   ((RTE_USB_OTG_HS_HOST == 1) && (!defined(USE_STM32756G_EVAL))&& (!defined(USE_STM32F769I_EVAL)) && (RTE_USB_OTG_HS_PHY == 0) && (RTE_OTG_HS_VBUS_PIN == 0))
...
#define  OTG_HS_GOTGCTL_VBVALOEN            ((uint32_t)    1U  <<  2)
#define  OTG_HS_GOTGCTL_VBVALOVAL           ((uint32_t)    1U  <<  3)
#define  OTG_HS_GOTGCTL_ABVALOEN            ((uint32_t)    1U  <<  4)
#define  OTG_HS_GOTGCTL_ABVALOVAL           ((uint32_t)    1U  <<  5)
#define  OTG_HS_GOTGCTL_BVALOEN             ((uint32_t)    1U  <<  6)
#define  OTG_HS_GOTGCTL_BVALOVAL            ((uint32_t)    1U  <<  7)
...
#define  OTG_HS_GOTGCTL_EHEN                ((uint32_t)    1U  << 12)
...
#define  OTG_HS_GOTGINT_IDCHNG              ((uint32_t)    1U  << 20)

// OTG_HS AHB configuration register (OTG_HS_GAHBCFG)
#define  OTG_HS_GAHBCFG_GINTMSK             ((uint32_t)    1U       )
...
#define  OTG_HS_GRSTCTL_PSRST               ((uint32_t)    1U  <<  1)
...
#define  OTG_HS_GCCFG_VBDEN                 ((uint32_t)    1U  << 21)

// OTG_HS core LPM configuration register (OTG_HS_GLPMCFG)
#define  OTG_HS_GLPMCFG_LPMEN               ((uint32_t)    1U       )
#define  OTG_HS_GLPMCFG_LPMACK              ((uint32_t)    1U  <<  1)
#define  OTG_HS_GLPMCFG_BESL_POS            ((uint32_t)           2U)
#define  OTG_HS_GLPMCFG_BESL_MSK            ((uint32_t)  0x0FU << OTG_HS_GLPMCFG_BESL_POS)
#define  OTG_HS_GLPMCFG_BESL(x)            (((uint32_t)    x   << OTG_HS_GLPMCFG_BESL_POS) & OTG_HS_GLPMCFG_BESL_MSK)
#define  OTG_HS_GLPMCFG_REMWAKE             ((uint32_t)    1U  <<  6)
#define  OTG_HS_GLPMCFG_L1SSEN              ((uint32_t)    1U  <<  7)
#define  OTG_HS_GLPMCFG_BESLTHRS_POS        ((uint32_t)           8U)
#define  OTG_HS_GLPMCFG_BESLTHRS_MSK        ((uint32_t)  0x0FU << OTG_HS_GLPMCFG_BESLTHRS_POS)
#define  OTG_HS_GLPMCFG_BESLTHRS(x)        (((uint32_t)    x   << OTG_HS_GLPMCFG_BESLTHRS_POS) & OTG_HS_GLPMCFG_BESLTHRS_MSK)
#define  OTG_HS_GLPMCFG_L1DSEN              ((uint32_t)    1U  << 12)
#define  OTG_HS_GLPMCFG_LPMRSP_POS          ((uint32_t)           13U)
#define  OTG_HS_GLPMCFG_LPMRSP_MSK          ((uint32_t)    3U  << OTG_HS_GLPMCFG_LPMRSP_POS)
#define  OTG_HS_GLPMCFG_LPMRSP(x)          (((uint32_t)    x   << OTG_HS_GLPMCFG_LPMRSP_POS) & OTG_HS_GLPMCFG_LPMRSP_MSK)
#define  OTG_HS_GLPMCFG_SLPSTS              ((uint32_t)    1U  << 15)
#define  OTG_HS_GLPMCFG_L1RSMOK             ((uint32_t)    1U  << 16)
#define  OTG_HS_GLPMCFG_LPMCHIDX_POS        ((uint32_t)           17U)
#define  OTG_HS_GLPMCFG_LPMCHIDX_MSK        ((uint32_t) 0x0FU  << OTG_HS_GLPMCFG_LPMCHIDX_POS)
#define  OTG_HS_GLPMCFG_LPMCHIDX(x)        (((uint32_t)    x   << OTG_HS_GLPMCFG_LPMCHIDX_POS) & OTG_HS_GLPMCFG_LPMCHIDX_MSK)
#define  OTG_HS_GLPMCFG_LPMRCNT_POS         ((uint32_t)           21U)
#define  OTG_HS_GLPMCFG_LPMRCNT_MSK         ((uint32_t)    7U  << OTG_HS_GLPMCFG_LPMRCNT_POS)
#define  OTG_HS_GLPMCFG_LPMRCNT(x)         (((uint32_t)    x   << OTG_HS_GLPMCFG_LPMRCNT_POS) & OTG_HS_GLPMCFG_LPMRCNT)
#define  OTG_HS_GLPMCFG_SNDLPM              ((uint32_t)    1U  << 24)
#define  OTG_HS_GLPMCFG_LPMRCNTSTS_POS      ((uint32_t)           25U)
#define  OTG_HS_GLPMCFG_LPMRCNTSTS_MSK      ((uint32_t)    7U  << OTG_HS_GLPMCFG_LPMRCNTSTS_POS)
#define  OTG_HS_GLPMCFG_LPMRCNTSTS(x)      (((uint32_t)    x   << OTG_HS_GLPMCFG_LPMRCNTSTS_POS) & OTG_HS_GLPMCFG_LPMRCNTSTS_MSK)
#define  OTG_HS_GLPMCFG_ENBESL              ((uint32_t)    1U  << 28)
...
#define  OTG_HS_HFIR_RLDCTRL                ((uint32_t)    1U  << 16)
...
#define  OTG_HS_DCTL_DSBESLRJCT             ((uint32_t)    1U  << 18)
...
#define  OTG_HS_DSTS_DEVLNSTS_POS           ((uint32_t)          22U)
#define  OTG_HS_DSTS_DEVLNSTS_MSK           ((uint32_t)    3U  << OTG_HS_DSTS_DEVLNSTS_POS)
#define  OTG_HS_DSTS_DEVLNSTS(x)           (((uint32_t)    x   << OTG_HS_DSTS_DEVLNSTSF_POS) & OTG_HS_DSTS_DEVLNSTS_MSK)
...
#define  OTG_HS_DIEPMSK_NAKM                ((uint32_t)    1U  << 13)
...
#define  OTG_HS_DOEPMSK_TXFURM              ((uint32_t)    1U  <<  8)
#define  OTG_HS_DOEPMSK_BOIM                ((uint32_t)    1U  <<  9)
#define  OTG_HS_DOEPMSK_NYETMSK             ((uint32_t)    1U  << 14)
...
#define  OTG_HS_DOEPCTLx_SD1PID             ((uint32_t)    1U  << 29)
...
#define  OTG_HS_PCGCCTL_ENL1GTG             ((uint32_t)    1U  <<  5)
#define  OTG_HS_PCGCCTL_PHYSLEEP            ((uint32_t)    1U  <<  6)
#define  OTG_HS_PCGCCTL_SUSP                ((uint32_t)    1U  <<  7)
